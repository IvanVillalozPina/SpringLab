...
//	private static final long serialVersionUID = 1404196032355826519L;
  ...
  /*  @OneToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
   ...
   // @Test
    public void finOutUserAndCategorias() {
    	
    	Alumn alumn = null;
    	
    	//Obtenermos el alumno
    	alumn = (Alumn).this.userRepository.findById(11L).orElse(null);
    	
    	// Imprimir categorias relacionadas
    ...
    public void deleteLinkingUserCategoria() {
    	...
    	alumn alumn = null;
    	//Obtenemos el alumno el cual se eliminará la relacion con sus categorias
    	alumn = (Alumn).this.userRepository.findById(11L).orElse(null);
    	alumn.setCategorias(null);
    	
    	//Se elimian las relaciones 
